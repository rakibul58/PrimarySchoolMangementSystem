 ...
 * @author USER
 */
public class GuardianResetPassword extends javax.swing.JFrame {

    /**
     * Creates new form ResetPassword
     */
    public GuardianResetPassword() {
        initComponents();
        clearTxt();
        connect();
    ...
    public void connect(){
        try {
            ...
            Logger.getLogger(GuardianResetPassword.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void resetBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_resetBtnActionPerformed
        try {
            ...
            if(!cntTxt.equals(GuardianLoginPage.getPass())){
                ...
                update = (PreparedStatement) con.prepareStatement("UPDATE Guardian SET password=? WHERE email=? and password = ?");
                update.setString(1,newTxt);
                update.setString(2,GuardianLoginPage.getEmail());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GuardianResetPassword.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GuardianResetPassword().setVisible(true);
            }
        });
    }
